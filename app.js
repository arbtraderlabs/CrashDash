            ...
            <td>
                <div style="display: flex; gap: 0.4rem; align-items: baseline; margin-bottom: 2px;">
                    <div>
                        ...
                        <span style="font-size: 0.95rem; color: var(--dark-gray); font-weight: 700;">${(triggerPrice * 100).toFixed(2)}p</span>
                    </div>
                    ...
                    <div>
                        ...
                        <span style="font-size: 0.65rem; color: rgba(44, 62, 80, 0.7); font-weight: 600;">${((metadata?.company_info?.current_close_price || currentPrice) * 100).toFixed(2)}p</span>
                    </div>
                </div>
